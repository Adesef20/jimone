          ...
          <div className="w-full max-w-lg p-4">
            <Accordion type="single" collapsible>
              <AccordionItem value="item-1">
                <AccordionTrigger>
                  What types of car do you sell?
                </AccordionTrigger>
                <AccordionContent>
                  We sell a wide range of vehicle sedans, SUVs, trucks and
                  luxury cars.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item2">
                ...
                <AccordionContent>
                  Absolutely! We offer trade-in options and provide fair
                  evaluation for your vehicle.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item3">
                ...
                <AccordionContent>
                  Yes, all our cars with warranty to ensure quanlity and
              ...
              <AccordionItem value="item4">
                ...
                <AccordionContent>
                  Simply contact us or visit our showroom to schedule a test
              ...
              <AccordionItem value="item5">
                ...
                <AccordionContent>
                  Yes, we provide flexible financing options
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>
