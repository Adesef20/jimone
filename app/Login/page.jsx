...
const Login = () =>{
    ...
    return(
        <div className="mt-10 flex flex-col items-center justify-center p-6 shadow-2xl w-full bg-white rounded">
            <h1 className="text-2xl font-bold mb-4 text-center rounded">Login Here</h1>
